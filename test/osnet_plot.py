...
def pseudo_labels_quality_curve(dir_path, output='curve_1.pdf'):
    ...
    # d2m
    path_list = ['cmld_eval_dukemtmc-2-market1501_osnet_ain_x1_0-osnet_ain_x0_5',
                 'cml_eval_dukemtmc-2-market1501_osnet_ain_x0_5',
                 'ml_eval_dukemtmc-2-market1501_osnet_ain_x0_5',
                 'clust_eval_dukemtmc-2-market1501_osnet_ain_x0_5']
    ...
    # m2d
    path_list = ['cmld_eval_market1501-2-dukemtmc_osnet_ain_x1_0-osnet_ain_x0_5',
                 'cml_eval_market1501-2-dukemtmc_osnet_ain_x0_5',
                 'ml_eval_market1501-2-dukemtmc_osnet_ain_x0_5',
                 'clust_eval_market1501-2-dukemtmc_osnet_ain_x0_5']
    for i, path in enumerate(path_list):
        file_name = os.path.join(dir_path, path, 'pseudo_labels_quality.csv')
        df = pd.read_csv(file_name, index_col='Epoch')
        x_labels = df.index.to_numpy(dtype=np.int32) + 1
    ...
    axs[0, 0].yaxis.set_ticks([0.1, 0.5, 0.6, 0.7, 0.8])
    axs[0, 1].yaxis.set_ticks([0.5, 0.87, 0.90, 0.93, 0.96])
    axs[1, 0].yaxis.set_ticks([0.1, 0.45, 0.5, 0.55, 0.6])
    axs[1, 1].yaxis.set_ticks([0.8, 0.88, 0.9, 0.92, 0.94])
...
def peer_and_ema_model_curve(dir_path, output='curve_2.pdf'):
    ...
    path_list = ['cmld_eval_dukemtmc-2-market1501_osnet_ain_x1_0-osnet_ain_x0_5',
                 'cmld_eval_market1501-2-dukemtmc_osnet_ain_x1_0-osnet_ain_x0_5']
...
def teacher_and_student_model_curve(dir_path, output='curve_3.pdf'):
    ...
    for i in range(axs.shape[0]):
        for j in range(axs.shape[1]):
            ...
            axs[i, j].set_xlabel('epoch')
    axs[0, 0].yaxis.set_ticks([1.5, 2.5, 3.5, 4.5])
    axs[0, 1].yaxis.set_ticks([50, 60, 70, 80])
    axs[0, 2].yaxis.set_ticks([75, 80, 85, 90])
    axs[1, 0].yaxis.set_ticks([1.5, 2.5, 3.5, 4.5])
...
def mutual_learning_student_model_curve(dir_path, output='curve_4.pdf'):
    ...
    d2m_path_list = ['cmld_dukemtmc-2-market1501_osnet_ain_x1_0-osnet_ain_x0_5',
                     'cmld_dukemtmc-2-market1501_osnet_ain_x1_0-osnet_ain_x0_5_single']
    m2d_path_list = ['cmld_market1501-2-dukemtmc_osnet_ain_x1_0-osnet_ain_x0_5',
                     'cmld_market1501-2-dukemtmc_osnet_ain_x1_0-osnet_ain_x0_5_single']
