...
pretrained_urls = {
    'osnet_ain_x1_0': './logs/pretrained/osnet_ain_x1_0_imagenet.pth',
    'osnet_ain_x0_75': './logs/pretrained/osnet_ain_x0_75_imagenet.pth',
    'osnet_ain_x0_5': './logs/pretrained/osnet_ain_x0_5_imagenet.pth',
    'osnet_ain_x0_25': './logs/pretrained/osnet_ain_x0_25_imagenet.pth'
}
...
# Instantiation
##########
def osnet_ain_x1_0(num_classes=1000, num_features=512, pretrained=False,
                   **kwargs
):
    model = OSNet(
        num_classes,
...
def osnet_ain_x0_75(num_classes=1000, num_features=512, pretrained=False,
                    **kwargs
):
    model = OSNet(
        num_classes,
...
def osnet_ain_x0_5(num_classes=1000, num_features=512, pretrained=False,
                   **kwargs
):
    model = OSNet(
        num_classes,
...
def osnet_ain_x0_25(num_classes=1000, num_features=512, pretrained=False,
                    **kwargs
):
    model = OSNet(
        num_classes,
