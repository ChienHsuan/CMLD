...
from ..loss import CrossEntropyLabelSmooth, SoftEntropy, SoftTripletLoss, ContrastiveLoss
from ..utils.meters import AverageMeter


class ContrastiveMLTrainer(object):
    def __init__(self, model_1, model_2, model_1_ema, model_2_ema, xbm_teacher_1,
                 xbm_teacher_2, target_loader, optimizer, num_cluster=500, alpha=0.999,
                 num_negative=10, contrastive_loss_margin=0.3, contrastive_loss_temperature_teacher=0.1):
        super(ContrastiveMLTrainer, self).__init__()
