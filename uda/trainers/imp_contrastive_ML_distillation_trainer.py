...
from ..loss import CrossEntropyLabelSmooth, SoftEntropy, SoftTripletLoss, PNContrastiveLoss, DistillKL
from ..utils.meters import AverageMeter


class ImpContrastiveMLDistillationTrainer(object):
    def __init__(self, model_1, model_2, model_1_ema, model_2_ema, model_student, xbm_teacher_1,
                 ...
                 num_negative=10, contrastive_loss_temperature_teacher=0.1,
                 contrastive_loss_temperature_student=0.7):
        super(ImpContrastiveMLDistillationTrainer, self).__init__()
        ...
        self.criterion_contrastive_teacher = PNContrastiveLoss(num_positive=4, num_negative=num_negative,
                                                               T=contrastive_loss_temperature_teacher)
        self.criterion_contrastive_student = PNContrastiveLoss(num_positive=4, num_negative=num_negative,
