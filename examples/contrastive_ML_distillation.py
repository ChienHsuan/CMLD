...
from uda.trainers import ContrastiveMLDistillationTrainer
...
def main_worker(args):
    ...
    for epoch in range(args.epochs):
        ...
        # Trainer
        trainer = ContrastiveMLDistillationTrainer(model_1, model_2, model_1_ema, model_2_ema, model_student, xbm_teacher_1,
