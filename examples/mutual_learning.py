...
from uda.trainers import MutualLearningTrainer
...
def main_worker(args):
    ...
    log_file_name = f'ml_{args.dataset_source}-2-{args.dataset_target}_{args.arch_teacher}_log.txt'
    ...
    for epoch in range(args.epochs):
        ...
        # Trainer
        trainer = MutualLearningTrainer(model_1, model_2, model_1_ema, model_2_ema, target_train_loader,
